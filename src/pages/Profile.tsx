      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Научный сотрудник</p>
            <div className="mx-auto mt-4.5 mb-5.5 w-80 rounded-md border border-stroke py-2.5 shadow-1 dark:border-strokedark dark:bg-[#37404F]">
              <div className="flex flex-col items-center justify-center gap-1 px-4">
                <span className="font-semibold text-black dark:text-white text-lg">
                  50
                </span>
                <span className="text-sm text-gray-500">экспериментов</span>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                Специалист в области резания материалов. Мое научное
                исследование направлено на разработку и оптимизацию методов
                резания для улучшения производительности и качества обработки
                материалов.
              </p>
            </div>
